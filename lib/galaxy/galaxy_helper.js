...
var GalaxyHelper = function() {
	...
	self.generateNavGraph = function(starTable, nearStarId, sectorTable, aabb, range) {
		...
		if (nearStarId != null) {
			...
			range = range || 1;
			var nearbyStars = self.findNearbyStars(starTable, sectorTable, aabb, nearStar, {searchArea:"sectors-near", range:range});
	...
	self.generateNavPath = function(starTable, sectorTable, aabb, starIdStart, starIdEnd) {
		var graph = self.generateNavGraph(starTable, starIdStart, sectorTable, aabb);
