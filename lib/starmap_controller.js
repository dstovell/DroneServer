...
function StarMapController(options) {
	...
	self.config = {
		starmap: {
			...
			starTypes: [
				{name:'Yellow Dwarf', color:'yellow', radius:10, img:'/game/starmap/Sun.png'},
				{name:'Red Giant', color:'red', radius:10, img:'/game/starmap/RedStar.png'},
				{name:'Blue Giant', color:'blue', radius:10, img:'/game/starmap/BlueStar.png'}
			]
		}
	}
